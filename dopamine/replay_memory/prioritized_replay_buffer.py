...
class OutOfGraphPrioritizedReplayBuffer(
	...
	def sample_transition_batch(self, batch_size=None, indices=None):
		...
		# The parent returned an empty array for the probabilities. Fill it with the contents of the sum tree.
	...
	def set_priority(self, indices, priorities):
		"""Sets the priority of the given elements according to Schaul et al.
			Args:
				indices: np.array with dtype int32, of indices in range [0, replay_capacity).
	...
	def get_transition_elements(self, batch_size=None):
		...
		parent_transition_type = (
				super(OutOfGraphPrioritizedReplayBuffer, self).get_transition_elements(batch_size))
...
@gin.configurable(blacklist=['observation_shape', 'stack_size', 'update_horizon', 'gamma'])
